...
export default function UGCPackageBuilder({ onGenerate, isLoading, creditBalance }: UGCPackageBuilderProps) {
  ...
  // Campaign shot prefill — from /campaigns/[id] → "Builder" deep link.
  // Read once here in the useState initializer scope so the form paints
  // pre-filled. Both prefill sources coexist; the campaign one wins
  // where fields overlap because it's more specific.

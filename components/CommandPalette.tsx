...
const PAGES: Array<{ label: string; href: string; group: string; sub?: string }> = [
  ...
  { label: 'Calendar', href: '/calendar', group: 'Navigation' },
  ...
  { label: 'POV Studio', href: '/generate/pov', group: 'Create', sub: 'Faceless POV ads — Seedance-powered' },
  { label: 'AI Video', href: '/generate/video', group: 'Create', sub: 'Sora 2 cinematic video' },

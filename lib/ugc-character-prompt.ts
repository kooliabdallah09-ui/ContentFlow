...
- Real, individual attractive person — no active acne / open blemishes / rough patches, but still REAL skin (faint pores, tiny freckles, subtle unevenness, slight redness at the nose/cheeks). Distinctive features and slight asymmetries. AVOID the generic AI-influencer face (plastic-glass skin, dead-symmetrical, over-groomed hair, cookie-cutter beauty). Natural hair with a few flyaways. Wardrobe should be casual and specific ("cream ribbed tank top", "oversized denim shirt"), not "trendy outfit".

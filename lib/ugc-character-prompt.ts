...
//   reference photo. This static string is a safe fallback only.
  ...
  'tv-spot':             'CINEMATIC TV AD FRAME — NOT a selfie. This is a premium commercial, not UGC. Wide or medium-wide shot with deliberate composition: character positioned off-centre OR shown in a lifestyle action (reaching for product, pouring, walking into scene). Professional lighting with depth — warm key light, soft fill, visible background bokeh or clean setting. Product visible and intentional. Think Apple or Nike ad, not TikTok. Character is NOT looking at a phone camera — they exist in the scene.',

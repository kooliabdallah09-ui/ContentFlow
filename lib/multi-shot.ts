...
- Real, individual attractive person — no active acne / open blemishes / rough patches, but STILL real skin texture (faint pores, tiny freckles, subtle unevenness, slight redness at the nose/ears). Distinctive features and slight asymmetries. AVOID the generic AI-influencer look (plastic-glass skin, dead-symmetrical face, over-groomed hair, cookie-cutter beauty).

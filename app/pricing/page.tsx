...
const PLANS = [
  ...
  },
  {
    ...
    features: ['UGC video ads — no watermark', '~7 UGC videos/month (5s)', 'AI image generator', 'AI voiceover', 'Actor library', 'Priority support'],
    cta: 'Get Starter',
  ...
  },
  {
    ...
    features: ['Everything in Starter', '~19 UGC videos/month (5s)', 'Software / app mode', 'Custom actor photo', 'Script editing', 'Shopify import'],
    cta: 'Get Pro',
  ...
  },
  {
    ...
    features: ['Everything in Pro', '~63 UGC videos/month (5s)', 'Multiple brand profiles', 'Dedicated support'],
    cta: 'Get Agency',

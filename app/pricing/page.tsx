...
const PLANS = [
  ...
  },
  {
    ...
    features: ['UGC video ads — no watermark', '~8 UGC videos/month (5s)', 'AI image generator', 'AI voiceover', 'Actor library', 'Priority support'],
    cta: 'Get Starter',
  ...
  },
  {
    ...
    features: ['Everything in Starter', '~22 UGC videos/month (5s)', 'Software / app mode', 'Custom actor photo', 'Script editing', 'Shopify import'],
    cta: 'Get Pro',
  ...
  },
  {
    ...
    features: ['Everything in Pro', '~71 UGC videos/month (5s)', 'Multiple brand profiles', 'Dedicated support'],
    cta: 'Get Agency',

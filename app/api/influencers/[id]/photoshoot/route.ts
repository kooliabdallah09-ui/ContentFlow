...
LIGHTING & LOOK: the lighting, colour palette, and time of day MUST match the SCENE above (a night neon street means DARK ambient with saturated neon rim/color spill on the subject; a sunny beach means warm daylight; an interior means whatever the scene describes). Never override the scene with generic daylight. Hyper-realistic candid smartphone photograph. GENUINELY ATTRACTIVE person — clear healthy skin with a natural sheen (magazine-worthy, no visible acne, no blemishes, no rough patches), symmetrical features, great bone structure, well-groomed hair. Real texture only in the sense of not-plastic — NOT in the sense of visible pores, spots, or "imperfections for realism". The goal is a beautiful real-looking person, like a top UGC creator, not "average person" and not "AI-doll perfect" either. NO shallow depth of field, NO editorial bokeh, NO magazine retouching, NO cinematic colour grade beyond what the scene naturally has.

...
const COMPETITORS: Record<CompetitorKey, CompetitorData> = {
  higgsfield: {
    ...
    summary: 'Higgsfield is a multi-model video aggregator with 30 million users. It bundles Sora, Veo, Kling, and Seedance under one subscription and recently added a Marketing Studio with UGC formats. It\'s a powerful video tool. But it stops at video.',

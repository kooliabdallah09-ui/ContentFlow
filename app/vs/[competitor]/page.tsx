...
const COMPETITORS: Record<CompetitorKey, CompetitorData> = {
  higgsfield: {
    ...
    metaDescription: 'ContentFlow vs Higgsfield: Higgsfield is cinema-grade for creative teams. ContentFlow is built for dropshippers who ship 20+ ad variants a week.',
    summary: 'Higgsfield is a cinema-grade AI creative suite — 30 million users, $700M ARR, 390 of the Fortune 500 as customers. Beautiful camera controls, motion transfer, agentic content generation. It\'s an incredible tool. It\'s just not built for a dropshipper who needs to ship 20 ad variants a week under $50/month.',
    ...
    whereWeWin: 'If you\'re a solo dropshipper or one-person store operator, Higgsfield fights you three ways. Their credits expire (ours never do). Their sweet spot is one polished clip, not batch-testing 20 hooks (we\'re built for velocity). And their outputs skew cinematic, not UGC — TikTok users can spot Higgsfield-style motion instantly. ContentFlow is deliberately built for the operator who ships every week, tests every hook, and needs ads that pass as real UGC.',
    verdict: 'These are two different tools for two different people. Higgsfield: cinematic content for creative teams with budget. ContentFlow: platform-safe UGC ads for store operators who ship every week. Neither is worse — they\'re solving different problems.',
  ...
  heygen: {
    ...
    whereWeWin: 'HeyGen\'s outputs read as "corporate presenter" — the wrong signal for UGC ads that need to look like a real person filmed on their phone. Their per-minute credit math punishes iteration (bad for testing 20 hooks a week). No product URL workflow, no Product Studio, no store-native features. ContentFlow is built for the opposite person: a solo dropshipper who needs UGC that passes as real, not enterprise polish.',

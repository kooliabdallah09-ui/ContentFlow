    ...
    <main style={{ maxWidth: 680, margin: '0 auto', padding: '42px 32px 90px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        {([
          ...
          { key: 'instagram', title: 'Instagram', desc: 'Publish and schedule content directly to Instagram.' },
          { key: 'meta-ads', title: 'Meta Ads', desc: 'Push creatives directly into your Meta Ads campaigns.' },

  ...
  const plans = [
    {
      ...
      features: [
        ...
        '~12 product images',
        '~12 AI voiceovers',
        '~2 standalone videos (4s)',
        'Business card generator',
        'Video editor (Beta)',
        'No UGC videos (need 91cr min)',
      ],
    ...
    },
    {
      ...
      features: [
        ...
        '~8 UGC videos/mo at 5s · ~4 at 10s · ~3 at 15s',
        '~160 product images or voiceovers',
        '~13 standalone videos (8s)',
        'No watermark',
        'Actor library & custom photos',
        'Video editor',
        'Priority support',
      ],
    ...
    },
    {
      ...
      features: [
        ...
        '~22 UGC videos/mo at 5s · ~11 at 10s · ~7 at 15s',
    ...
    },
    {
      ...
      features: [
        ...
        '~71 UGC videos/mo at 5s · ~38 at 10s · ~25 at 15s',
        '~1,300 product images or voiceovers',
        '~112 standalone videos (8s)',
        'Everything in Pro',
